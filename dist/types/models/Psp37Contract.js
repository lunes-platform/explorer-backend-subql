...
class Psp37Contract {
    ...
    async save() {
        let id = this.id;
        (0, assert_1.default)(id !== null, "Cannot save Psp37Contract entity without an ID");
        await store.set('Psp37Contract', id.toString(), this);
    }
    static async remove(id) {
        (0, assert_1.default)(id !== null, "Cannot remove Psp37Contract entity without an ID");
        await store.remove('Psp37Contract', id.toString());
    }
    static async get(id) {
        (0, assert_1.default)((id !== null && id !== undefined), "Cannot get Psp37Contract entity without an ID");
...
exports.Psp37Contract = Psp37Contract;
