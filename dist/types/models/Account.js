...
class Account {
    constructor(id, balance, sentTransfersCount, receivedTransfersCount) {
        this.id = id;
    ...
    static create(record) {
        ...
        let entity = new this(record.id, record.balance, record.sentTransfersCount, record.receivedTransfersCount);
